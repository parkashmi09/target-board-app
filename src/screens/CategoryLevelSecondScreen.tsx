...
type CategoryLevelSecondScreenRouteProp = RouteProp<MainStackParamList, 'CategoryLevelSecond'>;

const CategoryLevelSecondScreen: React.FC = () => {
  const theme = useTheme();
  const { colors } = theme;
  const navigation = useNavigation();
  const route = useRoute<CategoryLevelSecondScreenRouteProp>();
...
export default CategoryLevelSecondScreen;
